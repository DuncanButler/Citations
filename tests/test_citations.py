...
""")
            ...
            self.assertEqual(citations["test.py"][0]['source'], 'https://example.com/python-file')
            self.assertEqual(citations["test.py"][0]['author'], 'Python File Author')
            self.assertEqual(citations["test.js"][0]['source'], 'https://example.com/js-file')
...
""")
            ...
            citations_custom = self.extractor.extract_from_directory(temp_dir, ['.custom'])
